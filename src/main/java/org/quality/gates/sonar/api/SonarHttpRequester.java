...
public abstract class SonarHttpRequester {
    ...
    String getAPIInfoWithAnalysisId(JobConfigData configData, GlobalConfigDataForSonarInstance globalConfigDataForSonarInstance, String analysisId, String sonarApiQualityGatesStatusUrlAnalysisId) throws QGException {

        checkLogged(globalConfigDataForSonarInstance);

        String sonarApiQualityGates = globalConfigDataForSonarInstance.getSonarUrl() + String.format(getSonarApiQualityGatesStatusUrlAnalysisId(), analysisId);

        HttpGet request = new HttpGet(String.format(sonarApiQualityGates, analysisId));
    ...
    protected abstract String getSonarApiQualityGatesStatusUrlAnalysisId();
