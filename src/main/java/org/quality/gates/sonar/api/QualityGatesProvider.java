...
public class QualityGatesProvider {
    ...
    public QualityGatesStatus getAPIResultsForQualityGates(JobConfigData jobConfigData, GlobalConfigDataForSonarInstance globalConfigDataForSonarInstance, BuildListener listener) throws JSONException, InterruptedException {
        ...
        String analysisId = "";
        String sonarApiQualityGatesStatusUrlAnalysisId = "";
        ...
        do {
            ...
            analysisId = taskCE.getCurrent().getAnalysisId();

            sonarApiQualityGatesStatusUrlAnalysisId = sonarHttpRequester.getSonarApiQualityGatesStatusUrlAnalysisId();
        ...
        String requesterResult = getRequesterResultWithAnalysisId(jobConfigData, validatedData, analysisId, sonarApiQualityGatesStatusUrlAnalysisId);
        System.out.println("requesterResult -> "+requesterResult);
    ...
    private String getRequesterResultWithAnalysisId(JobConfigData jobConfigData, GlobalConfigDataForSonarInstance
            globalConfigDataForSonarInstance, String analysisId, String sonarApiQualityGatesStatusUrlAnalysisId) throws QGException {

        return sonarHttpRequester.getAPIInfoWithAnalysisId(jobConfigData, globalConfigDataForSonarInstance, analysisId, sonarApiQualityGatesStatusUrlAnalysisId);
    }
}
