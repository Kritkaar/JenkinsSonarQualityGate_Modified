...
public class SonarHttpRequester61 extends SonarHttpRequester {
    ...
    private static final String SONAR_API_QUALITY_GATES_STATUS_ANALYSISID = "/api/qualitygates/project_status?analysisId=%s";
    ...
    @Override
    protected String getSonarApiQualityGatesStatusUrlAnalysisId() {
        return SONAR_API_QUALITY_GATES_STATUS_ANALYSISID;
    }
